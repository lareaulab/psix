...
def load_turbo(turbo_dir = 'lookup/'):
    turbo_files = ['psix_'+str(i)+'.tab.gz' for i in range(1, 21)]
    turbo_dict = []
...
def make_turbo_function(out_dir = 'lookup/', granularity = 0.01, max_mrna = 20, capture_efficiency=0.1, min_probability=0.01):

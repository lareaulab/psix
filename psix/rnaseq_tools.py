...
def get_psi_table(SJ_counts_table, minJR=1, minCell=1, drop_duplicates = False, tenX = False):
    '''
...
#     constitutive_sj_file = '',
    ...
    psi, reads, constitutive_sj = get_psi_table(sj_file, minJR, minCell, drop_duplicates, tenX=tenX)

...
def compare_psix(psi_table, mrna_event, exon_list, all_exons, mrna_min_list, W, pval_dir, b=5, pv=1, 
                 times=1000, weight_observations=False):
        ...
        for mrna in mrna_min_list:
            ...
            if np.sum(mrna_event.loc[exon] >= mrna) < 100:
                ...
                psix_score = pr.calculate_exon_L(psi_table.mask(mrna_event < mrna), W, 
                    ...
                    min_probability = 0.01, psi_var=pv, times=times, weight_observations=weight_observations)
    ...
    for exon in tqdm(exon_list):
        for mrna in mrna_min_list:
            ...
            if np.sum(mrna_event.loc[exon] >= mrna) < 100:
                ...
                kw_score = uf.test_exon_bimodal_anova(psi_table.mask(mrna_event < mrna), 
...
if __name__ == '__main__':
    ...
    tiklova_psix = pd.read_csv('/mnt/lareaulab/cfbuenabadn/psix/development/psix_runs/tiklova_neurogenesis_wo_tm1000.scores.txt', 
                               sep='\t', index_col=0)

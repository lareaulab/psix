...
parser.add_argument('-pv', '--psi_var', type=float, required=False, default = 1,
                   help='Variance of PSI prior distribution.')

parser.add_argument('-cv', '--capture_var', type=float, required=False, default = 0.02,
                   help='Variance of capture efficiency prior.')
...
# parser.add_argument('-v', '--version', type=str, required=False, default = 'discrete',
#                     help 'discrete,psi_prior_1_,kneighbors')
